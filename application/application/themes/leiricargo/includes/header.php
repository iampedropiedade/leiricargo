    ...
    <nav class="navbar navbar-expand-lg classic !absolute navbar-dark !bg-black">
        <div class="container xl:!flex-row lg:!flex-row !flex-nowrap items-center">
            <div class="navbar-brand w-full">
                <a href="/">
                    <img class="logo-dark" src="<?php echo $this->getThemePath() ?>/app/img/logo-purple.png"
                         srcset="<?php echo $this->getThemePath() ?>/app/img/logo-purple@2x.png 2x" alt="image">
                    <img class="logo-light" src="<?php echo $this->getThemePath() ?>/app/img/logo-light.png"
                         srcset="<?php echo $this->getThemePath() ?>/app/img/logo-light@2x.png 2x" alt="image">
                </a>
            </div>
